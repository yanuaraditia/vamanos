    ...
    <section class="bg-dark pt-5 overflow-hidden contact text-white">
        <div class="container-fluid text-center pt-lg-5">
            <div>
                ...
                <g-link to="/join" class="btn btn-outline-primary btn-lg full-radius px-5">Cus langsung</g-link>
            </div>
            <g-image class="banner mx-auto" src="~/assets/images/DSC02340.png" fit="cover" immediate="false" blur="3"></g-image>
        </div>
    </section>
</template>
<style lang="scss">
